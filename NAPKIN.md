...
- **The convergence loop applies to every handoff.** The same gap between founder and builder exists between agent and subagent, maintainer and contributor. The convergence loop pattern — predict, score, adjust — makes the implicit explicit for any delegation, not just founder-to-builder.
